...
echo "# CONFIG_MAP_E_SUPPORT is not set" >> openwrt/target/linux/generic/config-6.6
echo "CONFIG_NF_CONNTRACK_DSCPREMARK_EXT=y" >> openwrt/target/linux/generic/config-6.6
echo "# CONFIG_NF_CONNTRACK_NPTV6_EXT is not set" >> openwrt/target/linux/generic/config-6.6
echo "CONFIG_NF_CONNTRACK_CHAIN_EVENTS=y" >> openwrt/target/linux/generic/config-6.6
echo "# CONFIG_NFT_NPT is not set" >> openwrt/target/linux/generic/config-6.6
echo "CONFIG_BRIDGE_NETFILTER=y" >> openwrt/target/linux/generic/config-6.6
